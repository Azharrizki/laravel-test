<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="{{ route('data-barang') }}"><i class="fas fa-store"></i>
            ...
            <li><a class="nav-link" href="{{ route('data-barang') }}"><i class="fas fa-shopping-cart"></i>
                    <span>Penjualan</span></a></li>
            <li><a class="nav-link" href="{{ route('data-barang') }}"><i class="fas fa-receipt"></i>
